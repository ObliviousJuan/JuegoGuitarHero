...
void setup() {
  ...
  file = new SoundFile(this, "Lynyrd Skynyrd - Sweet Home Alabama.mp3");
  file.play();
}
void draw() {
  keyReleased();
  background(0);
  image(Derecha, 50, 500, 100, 100);
  image(Abajo, 150, 500, 100, 100);
  image(Arriba, 250, 500, 100, 100);
  image(Izquierda, 350, 500, 100, 100);
